      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-header">
              ...
              <h4 class="modal-title" id="avatar-modal-label"><?=Yii::$app->language == 'zh-CN' ? '头像上传' : 'Upload avatar'?></h4>
          </div>
          <div class="modal-body">
              <div class="avatar-body">
                ...
                <div class="avatar-upload">
                  ...
                  <label for="avatarInput"><?=Yii::$app->language == 'zh-CN' ? '本地上传' : 'Local upload'?>：</label>
                ...
                <div class="row avatar-btns">
                  <div class="col-md-3">
                    <button type="submit" class="btn btn-hyii btn-block avatar-save"><?=Yii::$app->language == 'zh-CN' ? '上传' : 'Upload'?></button>
                  </div>
                </div>
              </div>
          </div>
